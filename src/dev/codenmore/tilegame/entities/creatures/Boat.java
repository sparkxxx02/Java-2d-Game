...
public class Boat extends Creature {
	...
	public Boat(Handler handler, float x, float y,Creature creature) {
		...
		//Animatons
		animDown = new Animation(100, Assets.boat_l);
		animUp = new Animation(100, Assets.boat_l);
		animLeft = new Animation(100, Assets.boat_l);
		animRight = new Animation(100, Assets.boat_r);
