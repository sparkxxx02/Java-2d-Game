...
public class Jet extends Creature {
	...
	public Jet(Handler handler, float x, float y,Creature creature) {
		...
		bounds.height = 19;
		//Animatons
		animDown = new Animation(100, Assets.jet_l);
		animUp = new Animation(100, Assets.jet_l);
		animLeft = new Animation(100, Assets.jet_l);
		animRight = new Animation(100, Assets.jet_r);
